...
class EllipticEnvelope(BaseSML):
    """Anomaly detection based on the EllipticEnvelope algorithm"""
    ...
    def learn_structure(self, samples):
        ...
        ee_detector = self._get_best_detector(X_train)
        Y_test = ee_detector.predict(X_test)
